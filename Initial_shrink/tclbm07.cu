...
int main(int argc, char **argv) try
{
    ...
    Dom.rho[0] = 0.5; //density of ice
    Dom.rho[1] = 1.0; //density of water
    Dom.rho[2] = 1.0; //density of air
    Dom.cap[0] = 1.0; //heat capcity of ice
    Dom.cap[1] = 1.0; //heat capacity of water
    Dom.cap[2] = 1.0; //heat capcity of air
    Dom.kap[0] = 0.1666; //heat condutivity of ice
    Dom.kap[1] = 0.1666; //heat conductivity of water 
    Dom.kap[2] = 0.1666; //heat conductivity of air
    Dom.thick  = 5.0; //thickness of interfase
    Dom.sigma  = 0.1; //surface tension
    Dom.Ts     = 0.5; //solidus temperature
    Dom.Tl     = 1.5; //liquidus temperature
    Dom.L      = 1.0; //Latent heat
    ...
    Dom.Solve(1.0e4,1.0e3,NULL,NULL,"tclbm07",true,1);
